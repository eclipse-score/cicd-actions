...
const skipDiskCacheRestore = core.getBooleanInput('skip-disk-cache-restore')
const skipRepositoryCacheRestore = core.getBooleanInput('skip-repository-cache-restore')
